...
import TrasladosPendientes from './TrasladosPendientes';
import HistoriasClinicasList from './HistoriasClinicasList';
...
function TrasladosPage() {
    ...
    const showHistoriasClinicas = ['admin', 'medico', 'enfermero'].includes(user.rol);
        ...
        <Box p={3}>
            ...
            <Paper sx={{ mb: 2 }}>
                <Tabs value={activeTab} onChange={handleTabChange}>
                    ...
                    {showHistoriasClinicas && <Tab label="Historias Clínicas" />}
            ...
            {activeTab === 2 && showHistoriasClinicas && (
                <HistoriasClinicasList
                    traslados={traslados.filter(t => t.tipo_servicio === 'AMBULANCIA')}
                    onUpdate={fetchData}
                    setError={setError}
                    setSuccess={setSuccess}
                />
            ...
            {activeTab === (showHistoriasClinicas ? 3 : 2) && user.rol === 'auditor' && (
                <TrasladosPendientes
