...
const Usuario = sequelize.define('Usuario', {
    ...
    rol: {
        type: DataTypes.ENUM('admin', 'contador', 'administrativo', 'operador', 'auditor', 'medico', 'enfermero'),
        allowNull: false,
        validate: {
            isIn: [['admin', 'contador', 'administrativo', 'operador', 'auditor', 'medico', 'enfermero']]
        }
    },
    estado: {
...
const getPermisosPorDefecto = (rol) => {
    ...
    const permisosPorRol = {
        ...
        Medico: {
            ...
            'editar_historia_clinica': true,
            'ver_pacientes': true,
            'ver_historias_clinicas': true
        },
        Enfermero: {
            ...permisosBase,
            'ver_traslados': true,
...
Usuario.associate = (models) => {
    ...
    Usuario.hasMany(models.HistoriaClinica, {
        foreignKey: 'medico_id',
        as: 'HistoriasClinicasMedico'
    });

    Usuario.hasMany(models.HistoriaClinica, {
        foreignKey: 'enfermero_id',
        as: 'HistoriasClinicasEnfermero'
    });
